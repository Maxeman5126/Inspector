...
const DefaultSettings = {
	...
	"Grotto of Lost Souls (Hard)": false,
	"Grotto of Lost Souls": false,
	"Lilith's Keep": false,
	"Macellarius Catacombs": false,
	"Manaya's Core": false,
	"Manglemire": false,
	"RK-9 Kennel (Hard)": false,
	"RK-9 Kennel": false,
	...
	"Sky Cruiser (Extreme)": true,
	"Corrupted Skynest (Hard) Entrance": false,
	"Draakon Arena (Hard)": true,
	"Forbidden Arena [Nightmare Undying Warlord]": true,
	"Corrupted Skynest": true,
	"Forbidden Arena [Hagufna]": true,
	"Timescape (Hard)": true,
	"Forbidden Arena [Undying Warlord]": true,
